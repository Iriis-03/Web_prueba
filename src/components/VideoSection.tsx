    ...
    <section id="video" className="py-24 bg-gradient-to-b from-blue-950/30 to-purple-950/40 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Actuaciones en Directo</h2>
          <div className="accent-line mx-auto mb-6"></div>
          <p className="text-xl text-gray-300">Energía y profesionalismo en cada presentación</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative group cursor-pointer rounded-xl overflow-hidden smooth-shadow aspect-video bg-gradient-to-br from-purple-900/20 to-blue-900/20">
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <p className="text-white font-semibold text-lg">Actuación en Eventos</p>
            </div>
          </div>
          ...
          <div className="relative group cursor-pointer rounded-xl overflow-hidden smooth-shadow aspect-video bg-gradient-to-br from-purple-900/20 to-blue-900/20">
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <p className="text-white font-semibold text-lg">Ambiente y Energía</p>
            </div>
          </div>
        </div>

        <div className="mt-12 text-center">
          <p className="text-gray-300 mb-4">Disponibles más videos de actuaciones completas</p>
          <a
            href="#contact"
